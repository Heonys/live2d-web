...
export const metadata: Metadata = {
  ...
  openGraph: {
    description:
      'Render Cubism 3/4/5 models with WebGL2. Add React, lip sync and face tracking only when your app needs them.',
    locale: 'en_US',
    siteName: 'live2d-web',
  ...
  twitter: {
    ...
    description:
      'Render Cubism 3/4/5 models with WebGL2. Add integrations only when your app needs them.',
    title: 'live2d-web · Live2D for the web',
  },
}
