...
function RuntimeDevtools({ target }: { target: Live2DModelController | null }) {
  ...
  return (
    <div className="runtime-devtools-host" ref={containerRef}>
      {!target && <p className="note">The model controls appear when loading finishes.</p>}
    </div>
  )
}
    ...
    <div className="code-drawer-backdrop" role="presentation" onClick={close}>
      ...
      >
        <div className="code-drawer-header">
          <div>
            <span>React</span>
            <strong>Playground essentials</strong>
          </div>
      ...
      <main className="playground-page">
        ...
        <section className="playground-workspace">
          ...
          <aside className="playground-panel">
            <div aria-label="Playground tools" className="playground-tabs" role="tablist">
            ...
            <div className="playground-panel-scroll">
              ...
              >
                ...
                <div className="playground-fieldset">
                  ...
                  {modelInfo?.expressions.length
                    ...
                    : modelInfo && (
                      <p className="note">
                        This model ships no expression files. Try your own model in the Inspector.
                      </p>
                    )}
              ...
              >
                <div className="panel-heading">
                  <span>Audio</span>
                  <h2>Lip sync inputs</h2>
                  <p>The app owns microphone permission and AudioContext; the library only analyses the signal.</p>
                </div>
                <label>
                  Lip-sync mode
                  <select
              ...
              >
                <div className="panel-heading">
                  <span>Tracking</span>
                  <h2>MediaPipe face tracking</h2>
                  <p>The camera stays in this panel while the model remains visible beside it.</p>
                </div>
                <video
                  ref={faceVideoRef}
