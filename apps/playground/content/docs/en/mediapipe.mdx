...
Warm local tracker creation is gated at a five-second median and is currently
well below that budget on the three desktop test engines. iPhone Safari still
