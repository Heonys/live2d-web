...
The placement, the method names and what does not come across are collected in [Migrating from pixi-live2d-display](/docs/en/pixi-live2d-display). Read it before rewriting anything: Cubism Core 5.3 is required, and a Cubism 2.1 model cannot move at all.
