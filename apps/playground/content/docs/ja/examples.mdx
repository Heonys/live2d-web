## 実際に build する project

repository には Vite JavaScript・Next React・Vue Vite・透明 OBS overlay の例があります。CI が4つを typecheck・production build します。既定 path は Core /live2dcubismcore.min.js、model /models/model.model3.json です。

- [Vite JavaScript 完全な source](https://github.com/Heonys/live2d-web/tree/main/examples/vanilla-vite)
- [Next React 完全な source](https://github.com/Heonys/live2d-web/tree/main/examples/next-react)
- [Vue Vite 完全な source](https://github.com/Heonys/live2d-web/tree/main/examples/vue-vite)
- [OBS overlay 完全な source](https://github.com/Heonys/live2d-web/tree/main/examples/obs-overlay)
