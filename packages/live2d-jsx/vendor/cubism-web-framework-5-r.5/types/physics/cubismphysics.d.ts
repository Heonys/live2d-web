...
import { CubismPhysicsInput, CubismPhysicsOutput, CubismPhysicsParticle, CubismPhysicsRig } from './cubismphysicsinternal';
/**
 * 物理演算クラス
 */
export declare class CubismPhysics {
    ...
    _inputSlices: Array<CubismPhysicsInput[]>;
    _outputSlices: Array<CubismPhysicsOutput[]>;
    _particleSlices: Array<CubismPhysicsParticle[]>;
