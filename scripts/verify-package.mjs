...
if (!/\bcreateVolumeLipSync\b/.test(rootDeclaration) || !/\bVolumeLipSyncDriver\b/.test(rootDeclaration))
  failures.push('root declarations are missing the volume lip-sync public API')
if (!/\bfadeInMs\??: number\b/.test(publicDeclarations) || !/\bfadeOutMs\??: number\b/.test(publicDeclarations))
  failures.push('root declarations are missing the motion fade public API')
