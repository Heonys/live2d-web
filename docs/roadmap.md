...
| **0.8** | 기능이 아니라 **소비자 복귀**. Livesona를 `^0.3.1`에서 최신으로 올리고 거기서 나온 결함으로 범위를 정한다 | 아래 "0.8 착수 조건"을 참조. 마이그레이션에서 나온 결함 수정과 그 과정 기록 |
| 0.9 이후 | 0.8이 만든 실제 요구 중 증거가 가장 강한 한 묶음 | 착수 조건과 소비자·측정 결과를 결정 기록에 남긴 뒤 범위 확정 |
